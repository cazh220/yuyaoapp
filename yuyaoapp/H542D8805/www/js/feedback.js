...
(function() {
	...
	var url = 'http://www.yrsyc.cn/yuyao/api/feedback.php';
	feedback.files = [];
...
//				console.log("event:"+e);
	...
	feedback.send = function(content) {
		//var vData = JSON.stringify(content)
		//alert(vData);
		mui.post('http://www.yrsyc.cn/yuyao/api/feedback.php',content,function(data){
